...
mod util;
pub use self::client::{
    Client, InstantQueryBuilder, LabelNamesQueryBuilder, MetricMetadataQueryBuilder,
    RangeQueryBuilder, RulesQueryBuilder, SeriesQueryBuilder, TargetMetadataQueryBuilder,
};
pub use self::direct::*;
